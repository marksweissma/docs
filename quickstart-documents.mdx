...
This guide walks you through connecting your AI assistant to Moxn Documents so it can search, read, and write documentation.

## What You'll Set Up

After this guide, your AI assistant will be able to:
- Search and read your team's documents for context
- Create and edit documents on branches (when you ask it to)
- Commit changes for you to review and merge

Writes happen on branches — your main content stays protected until you approve changes.
...
<CardGroup cols={2}>
  ...
  <Card title="Migration" icon="arrow-right-arrow-left" href="/migration/local">
    Import your existing docs into Moxn
  </Card>
</CardGroup>
