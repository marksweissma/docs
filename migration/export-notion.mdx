---
title: Export to Notion (CLI)
description: Push Moxn documents to a Notion workspace from the command line
---
...
<Tip>
**Prefer a UI?** The same export is available as the [in-app Notion integration](/migration/notion-integration#export-to-notion) — connect once in **Settings > Integrations** and Moxn runs the job for you. Both routes share the same converter; pick the CLI for scripted runs, CI, or fine-grained flag control.
</Tip>
