...
For CLI-based setup (no MCP; browser sign-in or API key), see [CLI Quick Start](/guides/context-cli). The CLI and MCP share sign-in credentials — log in once and both are authenticated.
